...
class WebPush
{
     ...
     */
    public function __construct(array $auth = [], array $defaultOptions = [], $timeout = 30, array $clientOptions = [])
    {
        $extensions = [
     ...
     * @throws \ErrorException
     */
    public function sendNotification(Subscription $subscription, $payload = null, bool $flush = false, array $options = [], array $auth = [])
    {
        if (isset($payload)) {
